...
Коллективная защита не даёт право на получение постоянного вида на жительство (ПМЖ) и гражданство, но можно со временем перейти на другое разрешение, которое даёт право на ПМЖ и гражданство: например, разрешение как специалист (виза специалиста). [:octicons-link-external-16: Детальнее об различных разрешениях на сайте Директоратата по делам иностранцев (UDI)](https://www.udi.no/uk/want-to-apply/?c=ukr).
...
Критерии коллективной защиты (см. вопрос ниже) относится как к взрослым, так и к несопровождаемым несовершеннолетним. Большинство информации здесь, и в официальных источниках относится как к взрослым, так и к несопровождаемым несовершеннолетним. Это означает, что несовершеннолетние дети без родителей могут получить коллективную защиту в Норвегии.
...
По приезду в Норвегию обратитесь к *Полиции* (Politi), или напрямую в места регистрации беженцев (см. список ниже). 
...
- В случае, если заявителю было отказано в **коллективной** защите, открывается дело на рассмотрения ходатайства об индивидуальной защите. 
...
- На время рассмотрения ходатайства, вы можете подать ходатайство о предоставлении вам разрешения на работу. 
