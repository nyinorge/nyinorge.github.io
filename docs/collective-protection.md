...
---
!!! updated ""
    :octicons-clock-16: Информация на этой странице актуальна по состоянию на **04.09.2023**
...
> - [Инструкция UDI 2022-004. Временная коллективная защита для перемещенных лиц из Украины](https://www.udiregelverk.no/rettskilder/udi-retningslinjer/udi-2022-004/#1.1._Hva_handler_retningslinjen_)
...
## 1.1. Я несовершеннолетний проситель коллективной защиты (без родителей)

Если вам еще не исполнилось 18 лет, и вы прибыли в Норвегию без родителей или иных опекунов с целью получить коллектвивную защиту, то вы являетесь *несопровождаемым несовершеннолетним просителем убежища*. 

Критерии коллективной защиты (см. след. вопрос) относится как к взрослым, так и к несопровождаемым несовершеннолетним. Большинтсво информации здесь, и в офциальных источниках относится как к взрослым, так и к несопровождаемым несовершеннолетним. Это означает, что несовершеннолетние дети без родителей могут получить коллективную защиту в Норвегии.

По норвежскому законодательству, в Норвегии каждый несопровождаемый проситель защиты и беженцы в возрасте до 18 лет получает *представителя* (временного опукуна). Представитель является юридическим лицом, заменяющим родителей. Главная задача представителя, это отслеживать, что соблюдаються права несовершеннолетнего. D задачи представителя в том числе входит:

- Cвязь с властями Норвегии
...
Представитель имеет право принимать за несовершеннолетнего решения, так же, как бы это было, если бы несовершеннолетний был бы в Норвегии вместе с своими родителями. 
...
Некоторые несопровождаемые несовершеннолетние прибывают в Норвегию вместе с другими взрослыми сопровождающими лицами. Первоначально им будет предложена возможность расместиться в муттак вместе с сопровождающими лицами.

Bufetat занимается расселением несопровождаемых несовершеннолетних беженцев в возрасте до 15 лет, прибывших в Норвегию самостоятельно. IMDi отвечает за расселение детей и молодых людей старше 15 лет. Именно IMDi подыскивает подходящю коммуну для несопровождаемых несовершеннолетних, прибывших со взрослым сопровождающим.

Несопровождаемые несовершеннолетние, проживающие в центре по уходу за детьми или в муттак, автоматически получают коммуну для поселения после получения вида на жительство и прохождения интервью.
...
> 
> - Если вы приехали в Осло **автобусом**, то вы можете обратиться в Полицейский участок **Grønland politistasjon** по адресу :material-map-marker: **Grønlandsleiret 44, 0190 Oslo** [(:octicons-link-external-16: карта)](https://www.google.com/maps/place/Gr%C3%B8nlandsleiret+44,+0190+Oslo/@59.9107932,10.7701928,17z/data=!4m6!3m5!1s0x46416e58a5a302f9:0x7c7e8523e2fc289!8m2!3d59.9107368!4d10.7704374!16s%2Fg%2F11bw3fcsvp?entry=ttu). Участок открыт с :material-clock: 08:00-23:00 ежедневно, включая выходные. Вам нужен "Politivakt" внутри участка.
>
...
- **Kirkenes**. Обратитесь в Полиции.
- **Trondheim**. Обратитесь к Полиции.
...
# 8. В чем разница коллективной защиты и индивидуальной защиты (убежище/asylum)?
...
По текущим правилам (Utlendingsloven § 28):
...
Иными словами, UDI будет рассматривать заявление на основании международных правил предоставления убежища на общих условиях.

## Расмотрения ходайтества о индивидуальной защите

- В случае, если заявителю было отказано в **коллективной** защите, открывается дело на рассмотрения ходайтества о индивидуальной защите. 
...
## Рассмотрение по *Дублинской* процедуре

Если Вы пребывали в одной из европейских стран, входящих в Дублинское сотрудничество, то дело о предоставлении убежища подпадает под Дублинскую процедуру. 
...
Заявление будет рассматриваться как Дублинское дело, если заявитель, ищущий защиты в Норвегии:
...
По Дублинской процедуре, не рассматривается, действительно ли человек имеет право на защиту. Рассматривается только возможность рассмотрения ходатайства о защите другой европейской страной, путем передачи дела государству-участнику Дублинского соглашения.
...
- На время рассмотрения ходатайства, вы можете подать ходатайтсво о предоставлении вам разрешения на работу. 
- Как правило, на время рассмотрения ходайтайства, у вас забирают паспорт.
...
- Если вы откажитесь от своего заявленния о предосталвении убежища, вы можете подать на иной тип разрешения. До тех пор, пока обязанность возвращения в Украину приостановлена, являсь гражданином Украины, [:octicons-link-external-16: Вы можете ходатайствовать о выдаче всех видов разрешений, находясь на территории Норвегии](https://udi.no/ru/information-ukraine-and-russia/situation-in-ukraine/stay-in-norway/protection-asylum-in-norway/if-you-do-not-meet-the-requirements-for-collective-protection/#link-31644).
